...
export default function StatusView() {
  ...
  const [serverRunning, setServerRunning] = useState<boolean | undefined>(undefined);
    ...
    <Paper variant="outlined" sx={{p: 2, margin: 2}}>
      <Grid container justifyContent="center" spacing={2} p={1}>
        <Grid item xs={12}>
          <Box sx={{
            p: 2,
            backgroundColor: serverRunning === undefined ? "yellow" : serverRunning ? "green" : "red",
          }}>
            Server status
          </Box>
        </Grid>
